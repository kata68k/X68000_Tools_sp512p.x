...
typedef struct {
    uint16_t base;   //	整数部分		222 (222 + (6617 / 10000))
    uint16_t add;    // 小数点部分		6617	
    uint16_t range;  // 小数点の精度	10000	
    uint16_t err;    // 誤差
} frac_timer_t;
...
extern uint16_t TimerD_INIT(uint16_t, uint16_t, uint16_t, uint16_t);
