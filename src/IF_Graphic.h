...
#define G16b_BLACK	(0x0000)
#define G16b_WHITE	(0xFFFF)
...
extern	int16_t G_STG68K_to_GR_Load(int8_t* , uint32_t , int16_t* , uint32_t , int8_t* , uint32_t , int16_t , int16_t , uint16_t, int8_t );
